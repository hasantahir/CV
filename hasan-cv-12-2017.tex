...
50-D Askari 1 Housing Scheme\\
Sarfaraz Rafiqui Road, Lahore Cantonment\\
...
\item[] Ph.D.,
        ...
        \item GPA 4.0
        \item Area of Study: Electromagnetic Theory and Plasmonics
        \end{innerlist}
\end{outerlist}
\halfblankline
...
\textbf{Electromagnetic wave propagation in layered media,
Plasmonics, Integral Equation based Electromagnetic analyis methods, Miniaturized on-chip Antennas, Two-dimensional Physics and materials}

\section{Objective}
%
Placement in an academic position that allows for advanced research in lower dimensional physics with an emphasis on nanoscale electromagnetic wave phenomena in plasmonic media, and an opportunity to share knowledge with others.
...
\item[2017] H.~T.~, Abbas, X.~, Zeng, M.~, AlAmri, R.~D.~, Nevels, M.~S.~, Zubairy, ``Nanoscopy using a semiconductor heterostructure as the sample stage'', submitted to Optics Express, 2017.
% \vspace{0.1in}
%
